...
export default function Home() {
  ...
  // ===== 答辩模式：从第一页开始，关闭自动播放，隐藏复杂控制栏，并尝试自动全屏 =====
  ...
  // ===== 键盘控制：左右键翻页、空格下一页、F 全屏、Esc 返回首页 =====
  useEffect(() => {
    const handleKey = (e) => {
      if (!started) return;
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-8 md:mt-12 flex flex-wrap items-center gap-4 md:gap-5">
              ...
              <button
                ...
                className="px-8 md:px-10 py-3 md:py-4 rounded-full bg-blue-400 text-black font-bold text-base md:text-lg hover:scale-105 transition"
              >
                答辩模式
              </button>
            </div>
...
<section className="relative z-10 px-6 md:px-16 py-20 md:py-28 border-t border-white/10">
        ...
        <section className="relative z-10 px-6 md:px-16 py-20 md:py-28 border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-5xl font-black">项目简介</h2>
            </div>
        ...
        <section className="relative z-10 px-6 md:px-16 py-20 md:py-28">
          <div className="max-w-6xl mx-auto">
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-5xl font-black">展示亮点</h2>
            </div>
  ...
  return (
    ...
    >
      ...
      {/* 答辩模式专属页码 */}
      {defenseMode && (
        <div className="absolute bottom-6 right-6 bg-black/50 backdrop-blur-md text-white px-5 py-2 rounded-full text-sm md:text-base">
          答辩模式 · {current + 1} / {slides.length}
        </div>
      )}
